...
var Password = "16charlengthp4SsW0rD1!@#_"
...
func TestVRFKeys_PrivateKey(t *testing.T) {
	...
	cryptoJSON, err := keystore.EncryptKey(k.toGethKey(), adulteratedPassword(Password), utils.FastScryptParams.N, utils.FastScryptParams.P)
	require.NoError(t, err)
